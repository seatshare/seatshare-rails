...
class GroupNotifierTest < ActionMailer::TestCase
  test "send group invitation" do
    ...
    assert_includes email.body.to_s, '<a href="/register?invite_code=ABCDEFG123">Use Invitation ABCDEFG123</a>'
    assert_includes email.body.to_s, 'Sarah Becker has invited you to join our <strong>Nashville Predators</strong> group on <a href="/">SeatShare</a>, a service that helps manage our season tickets.'
  end
end
